        ...
        while self.operational:
            ...
            if commands is not None:
                if bool(commands.get("commands")):
                    logging.debug("New Commands Received.\nCommands: {}".format(commands["commands"]))
                    self.executeCommands(commands=commands)
                else:
    ...
    def pullCommands(self):
        try:
            ...
            if commands.status_code != 200:
                logging.warning("Connection Error To Command Server. Response Code: {}\nJson return: {}\nFull text: {}".format(commands.status_code,
            ...
            logging.warning("Critical Error Has Occurred While Trying To Connect To Command Server. Error Message: {}\n{}".format(e, traceback.format_exc()))
            return None
        ...
        for command in commands.json()["commands"]:
            try:
                ...
                try:
                    ...
                    logging.info("New Command Passed To Manger\nCommand Type: {}\nCall Back {}".format(commandType, callBack))
                ...
                logging.warning("KeyError Decoding Command. Command Failed\n Error Message: {}\nFull Command Json: {}\n{}".format(KE, command,
                                                                                                                                  traceback.format_exc()))

            except Exception as e:
                logging.warning("Exception Decoding Command. Command Failed\nError Message: {}\nFull Json Command: {}\n{}".format(e, command,
                                                                                                                                  traceback.format_exc()))
